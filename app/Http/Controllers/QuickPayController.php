...
class QuickPayController extends Controller
{
    ...
    {
        $api_key = Config::get('quickpay.QUICKPAY_API_KEY');
        $facilitator = Config::get('quickpay.QUICKPAY_FACILITATOR');
        $testmode = Config::get('quickpay.QUICKPAY_TEST_MODE');
        $autocapture = Config::get('quickpay.QUICKPAY_AUTO_CAPTURE');
        $merchant_id = Config::get('quickpay.QUICKPAY_MERCHANT_ID');
